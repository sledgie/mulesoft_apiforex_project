:toc:               left
:toc-title:         Currency Converter Connector
:toclevels:         2
:last-update-label!:
:docinfo:
...
= Currency Converter Connector Documentation Reference
...
|======================
| Name | Type | Description | Default Value | Required
| Connection Timeout a| Number |  +++A parameter that is always required to be configured.+++ |  +++50000+++ | {nbsp}
| Base a| String |  +++Base: EUR, CAD, PHP, INR+++ |  | *x*{nbsp}
| Target a| String |  +++Target: EUR, CAD, PHP, INR+++ |  | *x*{nbsp}
| Reconnection a| <<Reconnection>> |  +++When the application is deployed, a connectivity test is performed on all connectors. If set to true, deployment will fail if the test doesn't pass after exhausting the associated reconnection strategy+++ |  | {nbsp}
| Pooling Profile a| <<PoolingProfile>> |  +++Characteristics of the connection pool+++ |  | {nbsp}
|======================

==== Associated Operations
* <<convertCurrency>> {nbsp}
...
==== Throws
* CURRENCY-CONVERTER:RETRY_EXHAUSTED {nbsp}
* CURRENCY-CONVERTER:CONNECTIVITY {nbsp}


[[logScope]]
=== Log Scope
`<currency-converter:log-scope>`
